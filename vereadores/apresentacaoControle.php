    ...
    <span class="tela_auxiliar" style="float: right; margin-right: 10px;">
        ...
        $(function(){
            setInterval(function(){
                chamarPaginaAjax('uso_palavra_controle.php?att=true', '', function(r) {
                   $('#uso_palavra_controle').html(r); 
                });
            }, 3000);
        })
        </script>
        <span class="listagem" id="uso_palavra">
            <?php
            include("uso_palavra_controle.php");
            ?>
        </span>
    </span>
...
<?php
echo "Presidente da Câmara: ".$vereador->getNome($_SESSION['vereador']);
include("rodape.php");
