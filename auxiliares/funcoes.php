...
class funcoes {
    ...
    public static function montaInput($nome, $tipo, $valor ='', $maximo = '') {
        if ($tipo == 'int') {
            return "<input type='text' data-tipo='int' name='{$nome}' value='{$valor}' onblur=\"checkValorMaximo(this, {$maximo})\"/>";
        }
        else if ($tipo == 'float') {
            return "<input type='text' data-tipo='float' name='{$nome}' value='{$valor}' onblur=\"checkValorMaximo(this, {$maximo})\"/>";
        }
        else if ($tipo == 'monetario') {
            return "<input type='text' data-tipo='monetario' name='{$nome}' value='{$valor}' onblur=\"checkValorMaximo(this, {$maximo})\"/>";
        }
        else if ($tipo == 'str') {
